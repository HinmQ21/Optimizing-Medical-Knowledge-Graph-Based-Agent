...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="HuatuoGPT-o1 style stage-1 SFT using Unsloth + Transformers Trainer with assistant-only masked loss."
    )
    ...
    parser.add_argument("--output-dir", default="outputs/huatuo_stage1_qwen25_3b_unsloth_trainer")
    ...
    parser.add_argument("--run-name", default="huatuo-stage1-qwen25-3b-unsloth-trainer")
...
def normalize_special_tokens(tokenizer, model) -> None:
    ...
    # Cố gắng phục hồi EOS token hợp lệ nếu tokenizer metadata bị lỗi kiểu "<EOS_TOKEN>"
...
def convert_to_tokenized_chat_dataset(
    ...
    def map_row(example: dict[str, Any]) -> dict[str, Any]:
        ...
        # Sau apply_chat_template thì không add_special_tokens lần nữa
